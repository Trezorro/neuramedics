...
all_labels = pd.read_csv("/Users/blazejmanczak/Desktop/School/Year2/Q2/DataChallange1/augmented_labels.csv", usecols=['image', 'level'])
...
def get_train_test(size_train, size_test, original_labels):
    ...
    train0 = original_labels[original_labels['level']==0][(size_test*3): (size_test+size_train)*3]['image'] # *3 because in augmented we double healthy and 6x sick
    ...
    test0 = original_labels[original_labels['level']==0][:(size_test*3)]['image']
